...
import BabySinglePage from "./babysinglepage"
const initState = {
    products:[],
    isLoading:false,
    isErr:false,
...
function Baby(){
    ...
    const getData=()=>{
        ...
        if(orderBy){
            return axios.get(`http://localhost:8080/baby?_limit=6&_page=${page}&_sort=${sort}&_order=${orderBy}`)
            .then((res)=>{
            ...
            return axios.get(` http://localhost:8080/baby?_limit=6&_page=${page}`)
            .then((res)=>{
                dispatch({type:"FETCH_SUCCESS",payload:res.data})
                setTotal(+res.headers.get('X-Total-Count'))
            })
    ...
    return (
        <>
            <Heading as="h1" size="xl" fontWeight="semibold" color="cyan.500" mt="4vh" >Baby Clothes</Heading>
            <Text color="blackAlpha.800" fontSize="sm" mt="2vh" >Effortless essentials, special little styles and so much more. See why parents have loved our baby clothes for generations.</Text>
            ...
            <Box w="90%" m="15vh auto 4vh "  >
                ...
                <GridItem _hover={{border:"4px solid lightgrey"}} cursor="pointer">
                    ...
                    <GridItem _hover={{border:"4px solid lightgrey"}} cursor="pointer">
                        <Flex>
                            <Image src="https://cdn-fsly.yottaa.net/578855e22bb0ac10350002d6/www.carters.com/v~4b.295/content/dam/ecomm/ec_creative_carters/2022/cslp%27s/car_q3_2022_cslps/CAR_CSLPS_Q3_22_SH.jpg?yocs=4E_4G_" w="50%" />
                            <Box width="50%" bgColor="blackAlpha.200" pt="8vh" >
                                <Heading color="cyan.500" as="h3" size="lg" fontWeight="semibold" >Skip Hop</Heading>
                                <Text fontSize="sm" textAlign="center" pt="3vh" >Innovative & Stylish Must-Haves Made better for playtime, bathtime & all the time</Text>
                                <Heading pt="4vh" as="h4" size="md" fontWeight="normal" _hover={{textDecoration:"underline"}} >SHOP SKIP HOP</Heading>
                            </Box>
                        </Flex>
                    </GridItem>
                    <GridItem _hover={{border:"4px solid lightgrey"}} cursor="pointer">
            ...
            <Box h="90vh" w="80%" m="auto" >
                <Heading as="h1" size="xl" fontWeight="thin" color="cyan.500" mt="4vh"> Life with Kids</Heading>
                ...
                <Flex w="100%" justifyContent="center" mt="4vh" h="60vh" >
                        <Image src="https://s7img.carters.com/is/image/carters/CART101(2)" w="35%" cursor="pointer" />
                        <Box width="65%" bgColor="blackAlpha.200" pt="20vh" >
                            <Heading  as="h3" size="lg" fontWeight="normal" >The Ultimate Guide to Carter’s Original Bodysuit</Heading>
                            <Text fontSize="sm" textAlign="center" pt="1vh" >Carter’s bodysuits are the perfect base layer to every baby’s outfit.</Text>
                        </Box>
                </Flex>
